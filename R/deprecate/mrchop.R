...
#' 
#' @description Map function to a 2D dataset and reduce the results based on a given margin. 
#' 
...
#' 
#' @details \code{\link{mapreduce}} with the option to apply a function over the columns or rows. Effectively, it calls \code{\link{apply}} and \code{\link{mapreduce}}; however, \code{mrchop} is not multivariate, similar to the former.
#' 
